...
class SubmissionCard extends StatelessWidget {
  const SubmissionCard({Key? key, required this.user, required this.details}) : super(key: key);
          ...
          children: [
            ...
            Padding(
              ...
              child: TextButton.icon(
                ...
                onPressed: (){
                  Navigator.of(context).pushReplacementNamed('/single_submission_page',arguments: ScreenArguments(user, details));
                },
                label: Text(''),
              ),
            )
